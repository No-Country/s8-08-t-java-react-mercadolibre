    ...
    <section className="bg-[#eeeeee] flex grow">
      <div className="mx-10 sm:mx-24 lg:ml-14 lg:mr-0 font-medium text-[#504A4A] w-full max-w-[825px]">
        ...
        <div>
          ...
          <div
            className={`flex items-center justify-between w-full max-w-[825px] bg-[#FFFFFF] h-[60px] rounded mb-6 border-l-4 cursor-pointer ${selectedOption === "home delivery" ? "border-ligthblue" : "border-transparent"
              }`}
        ...
        <div>
          ...
          <div
            className={`flex items-center justify-between w-full max-w-[825px] bg-[#FFFFFF] h-[60px] rounded mb-6 border-l-4 cursor-pointer ${selectedOption === "mail delivery" ? "border-ligthblue" : "border-transparent"
              }`}
