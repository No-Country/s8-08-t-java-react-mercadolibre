                        ...
                        <div className="bg-white rounded-md p-10 sm:mt-0 pb-14">
                            <div className="flex flex-col sm:flex-row justify-start items-center gap-5 mb-2">
                                <div className="flex flex-col w-[294px]">
                                    <label
                                        htmlFor="firstName"
                                        className={`text-sm ml-2 ${formik.errors.firstName !== undefined ? "text-red" : "text-black"
                                            }`}
                                    >
                                        Nombre
                                    </label>
                                    <input
                                        ...
                                        className={`w-full max-w-[294px] h-12 rounded-md border p-3 focus:outline-none focus:border-2 ${formik.errors.firstName !== undefined
                                ...
                                <div className="flex flex-col w-[294px]">
                                    <label
                                        htmlFor="lastName"
                                        className={`text-sm ml-2 ${formik.errors.lastName !== undefined ? "text-red" : "text-black"
                                            }`}
                                    >
                                        Apellido
                                    </label>
                                    <input
                                        ...
                                        className={`w-full max-w-[294px] h-12 rounded-md border p-3 focus:outline-none focus:border-2 ${formik.errors.lastName !== undefined
                                            ? "border-red focus:border-red"
                                            : "border-[#bfbfbf] focus:border-ligthblue"
                                            }`}
                                        onChange={formik.handleChange}
                            ...
                            <div className="flex flex-col sm:flex-row justify-start items-center gap-5 mb-2">
                                <div className="flex flex-col w-[294px]">
                                    <label
                                        htmlFor="email"
                                        className={`text-sm ml-2 ${formik.errors.email !== undefined ? "text-red" : "text-black"
                                            }`}
                                    >
                                        E-mail
                                    </label>
                                    <input
                                        ...
                                        className={`w-full max-w-[294px] h-12 rounded-md border p-3 focus:outline-none focus:border-2 ${formik.errors.email !== undefined
                                            ? "border-red focus:border-red"
                                            : "border-[#bfbfbf] focus:border-ligthblue"
                                            }`}
                                        onChange={formik.handleChange}
                                ...
                                <div className="flex flex-col w-[294px]">
                                    <label
                                        htmlFor="password"
                                        className={`text-sm ml-2 ${formik.errors.password !== undefined ? "text-red" : "text-black"
                                            }`}
                                    >
                                        Clave
                                    </label>
                                    <input
                                        ...
                                        className={`w-full max-w-[294px] h-12 rounded-md border p-3 focus:outline-none focus:border-2 ${formik.errors.password !== undefined
                                            ? "border-red focus:border-red"
                                            : "border-[#bfbfbf] focus:border-ligthblue"
                                            }`}
                                        onChange={formik.handleChange}
                                    ...
                                    {formik.errors.password !== undefined ? (
                                        ...
                                        <span className="text-xs text-[#0000008c] p-2">Usá entre 6 y 20 caracteres</span>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col mt-8 sm:mt-5 relative">
                                <div className="flex items-center gap-3">
                                    ...
                                    <label htmlFor="conditions" className="text-xs text-[#0000008c]">
                                        Acepto los <span className="text-ligthblue">Términos y Condiciones</span> y autorizo el uso de mis datos de acuerdo a la <span className="text-ligthblue">Declaración de Privacidad.</span>
                                    </label>
                                </div>
